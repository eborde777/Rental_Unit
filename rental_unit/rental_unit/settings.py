"""
Django settings for rental_unit project.
...
import os
from .my_keys import PRO_SECRET_KEY, postgres_password, postgres_port, postgres_username
...
WSGI_APPLICATION = 'rental_unit.wsgi.application'
